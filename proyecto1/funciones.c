...
struct COMPARACION *map(LISTA *lista, COMPARACION *estructura) {
	...
	resultado = agregar(pareja, estructura);
...
struct LISTA *reduce (COMPARACION *estructura, LISTA *definitivo) {
